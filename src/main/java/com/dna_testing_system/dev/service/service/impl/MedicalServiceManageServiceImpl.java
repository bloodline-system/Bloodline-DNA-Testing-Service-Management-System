...
//        refreshedService.getServiceFeatures().addAll(savedService.getServiceFeatures());
    ...
    @Override
    public Page<MedicalServiceResponse> getServicesPage(Pageable pageable) {
    ...
    @Override
    public Page<MedicalServiceFilterResponse> searchServicesPage(String name, Pageable pageable) {
        return medicalServiceRepository.searchAllByServiceNameContaining(name, pageable)
                .map(medicalServiceMapper::toFilterResponse);
    }
    ...
    @Override
    public Page<ServiceTypeResponse> getServiceTypesPage(Pageable pageable) {
